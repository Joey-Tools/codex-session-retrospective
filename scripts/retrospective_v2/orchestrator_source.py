...
from .source_session_policy import validate_session_record_binding
    ...
    def _manifest_from_transport_capture(
        ...
        for inventory in capture.inventory:
            ...
            session_identity = catalog.SessionIdentityWitness(
                direct_commitments=tuple(inventory["direct_session_commitments"]),
                locator_commitments=tuple(inventory["locator_session_commitments"]),
            )
    ...
    def _validate_source_binding(
        ...
        for record in manifest.records:
            ...
            validate_session_record_binding(
                self.identity,
                active=state.get("mode") == RunMode.SESSION.value,
                host_ref=lease.host_ref,
                session_target=session_target,
                session_selector_commitment=state.get("session_selector_commitment"),
                record=record,
            )
