...
branch proxy is 8,512/8,525 nodes after adding receipt-bound Session identity
witness validation to executable path, content, and access-policy authority to
...
its support slice are 3,042/3,050 lines; the three source-staging modules
