...
class AuditedResultContractTests(unittest.TestCase):
    ...
    def test_audit_redacts_the_complete_labeled_personal_value(self) -> None:
        for source in (
            ...
            "Observed employee middle name: Alice before continuing.",
            "Observed employee middle_name: Alice before continuing.",
            "Observed employee middle-name: Alice before continuing.",
            "Observed customer surname: Smith before continuing.",
            "Observed customer family name: Smith before continuing.",
            "Observed customer family_name: Smith before continuing.",
            "Observed customer family-name: Smith before continuing.",
            "Observed customer given name: Alice before continuing.",
            "Observed customer given_name: Alice before continuing.",
            "Observed customer given-name: Alice before continuing.",
            ...
            "Observed employeeMiddleName: Alice before continuing.",
            "Observed customerSurname: Smith before continuing.",
            "Observed customerFamilyName: Smith before continuing.",
            "Observed customerGivenName: Alice before continuing.",
            "Observed customer legal name: Alice Smith before continuing.",
            "Observed customer preferred_name: Alice before continuing.",
            "Observed customer maiden-name: Smith before continuing.",
            "Observed customer nickname: Alice before continuing.",
            "Observed customer display name: Alice Smith before continuing.",
            "Observed customer display_name: Alice Smith before continuing.",
            "Observed customer display-name: Alice Smith before continuing.",
            "Observed customer full name: Smith, John before continuing.",
            "Observed customer display name: Smith, John before continuing.",
            "Observed customerLegalName: Alice Smith before continuing.",
            "Observed customerPreferredName: Alice before continuing.",
            "Observed customerMaidenName: Smith before continuing.",
            "Observed customerNickname: Alice before continuing.",
            "Observed customerDisplayName: Alice Smith before continuing.",
            "Observed customerDisplayName: Smith, John before continuing.",
            "Observed **Legal name:** Alice Smith before continuing.",
            "Observed **Display name:** Alice Smith before continuing.",
            "Observed Preferred name is Alice before continuing.",
            "Observed Maiden name was Smith before continuing.",
            "Observed Nickname is Alice before continuing.",
            "Observed Display name was Alice Smith before continuing.",
            ...
            "Observed Birthday: 1990-01-02 before continuing.",
            "Observed Birth date: 1990-01-02 before continuing.",
            "Observed Birthdate: 1990-01-02 before continuing.",
            "Observed Birth_date: 1990-01-02 before continuing.",
            "Observed Birth-date: 1990-01-02 before continuing.",
            "Observed birthDate: 1990-01-02 before continuing.",
