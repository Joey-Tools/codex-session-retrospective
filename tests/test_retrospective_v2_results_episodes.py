...
class ResultValidationTests(unittest.TestCase):
    ...
    def test_source_overlap_extracts_sensitive_labeled_values(self) -> None:
        cases = (
            ...
            (
                "Diagnoses: asthma",
                "Asthma was referenced",
                "[REDACTED_ORIGINAL_PROMPT] was referenced",
            ),
            (
                "Medications: sertraline",
                "Sertraline was referenced",
                "[REDACTED_ORIGINAL_PROMPT] was referenced",
            ),
            (
                "Nationalities: Canadian",
                "Canadian was referenced",
                "[REDACTED_ORIGINAL_PROMPT] was referenced",
            ),
            (
                "politicalOpinions: environmentalist",
                "Environmentalist was referenced",
                "[REDACTED_ORIGINAL_PROMPT] was referenced",
            ),
            (
                "trade_union_memberships: Example Union",
    ...
    def test_health_biometric_contact_and_cookie_fields_share_privacy_policy(
        ...
        cases = (
            ...
            (
                "__Genetic information:__ BRCA positive",
                "personal_identifier",
                "[REDACTED_PERSONAL_IDENTIFIER]",
            ),
            (
                "Medical condition was diabetes",
                "personal_identifier",
                "[REDACTED_PERSONAL_IDENTIFIER]",
            ),
            (
                "Health status is diabetic",
                "personal_identifier",
                "[REDACTED_PERSONAL_IDENTIFIER]",
            ),
            (
                "Genetic information was BRCA positive",
                "personal_identifier",
                "[REDACTED_PERSONAL_IDENTIFIER]",
            ),
            (
                "Health data: diabetes",
                "personal_identifier",
                "[REDACTED_PERSONAL_IDENTIFIER]",
            ),
            (
                "Medical data: diabetes",
                "personal_identifier",
                "[REDACTED_PERSONAL_IDENTIFIER]",
            ),
            (
                "Clinical information: HIV positive",
                "personal_identifier",
                "[REDACTED_PERSONAL_IDENTIFIER]",
            ),
            (
                "clinical_data: HIV positive",
                "personal_identifier",
                "[REDACTED_PERSONAL_IDENTIFIER]",
            ),
            (
            ...
            (
                "clinicalInformation: HIV positive",
                "personal_identifier",
                "[REDACTED_PERSONAL_IDENTIFIER]",
            ),
            (
            ...
            (
                "Protected health information: diabetes",
                "personal_identifier",
                "[REDACTED_PERSONAL_IDENTIFIER]",
            ),
            (
                "protectedHealthInformation: diabetes",
                "personal_identifier",
                "[REDACTED_PERSONAL_IDENTIFIER]",
            ),
            (
    ...
    def test_demographic_fields_share_retained_privacy_policy(self) -> None:
        for source in (
            ...
            "Sexes assigned at birth: female and male",
            "Sex at birth: female",
            "Assigned sex: female",
            "Assigned sexes: female and male",
            "Assigned sex at birth: female",
            "Birth sex: female",
            "Birth sexes: female and male",
            "Gender assigned at birth: female",
            "Genders assigned at birth: female and male",
            "Gender at birth: female",
            "Assigned gender: female",
            "Assigned genders: female and male",
            "Assigned gender at birth: female",
            "Birth gender: female",
            "Birth genders: female and male",
            "sex_assigned_at_birth: female",
            "sex_at_birth: female",
            "assigned_sex_at_birth: female",
            "birth_sex: female",
            ...
            "age-ranges: 40-49",
            "Gender: woman",
            "Genders: women and nonbinary people",
            "Gender identity: nonbinary",
            "Gender identities: nonbinary",
            "gender_identities: nonbinary",
            "gender.identities: nonbinary",
            "gender-identities: nonbinary",
            "Gender expression: feminine",
            "Gender expressions: feminine",
            "gender_expressions: feminine",
            "gender.expressions: feminine",
            "gender-expressions: feminine",
            "Pronouns: she/her",
            "Race: Black",
            ...
            "Racial origin: Example origin",
            "Religious belief: Example belief",
            "Religious beliefs: Example beliefs",
            "ethnic_origin: Han Chinese",
            "racial-origin: Example origin",
            "religious_belief: Example belief",
            "Ethnic background: Han Chinese",
            "Ethnic backgrounds: Han Chinese and Cantonese",
            "Racial background: Example background",
            "Racial backgrounds: Example backgrounds",
            "Religious affiliation: Example faith",
            "Religious affiliations: Example faith",
            "Ethnic group: Example group",
            "Ethnic groups: Example groups",
            "Racial identity: Example identity",
            "Racial identities: Example identities",
            "Religious denomination: Example denomination",
            "Religious denominations: Example denomination",
            "Religious identities: Example identity",
            "Faith: Example faith",
            "Faiths: Example faith",
            "Creed: Example creed",
            "Creeds: Example creed",
            "ethnic_background: Han Chinese",
            "racial-background: Example background",
            "religious_affiliation: Example faith",
            "Caste: Example caste",
            "Castes: Example caste",
            "Marital status: married",
            "Marital statuses: married",
            "marital_status: married",
            "Family status: caregiver",
            "Family statuses: caregiver",
            "Disability: disabled",
            "Disabilities: paraplegia",
            "Disability status: disabled",
            "Disability statuses: disabled",
            "Pregnancy: pregnant",
            "Pregnancies: pregnant",
            "Pregnancy status: pregnant",
            "Pregnancy statuses: pregnant",
            "Veteran: veteran",
            "Veterans: veteran",
            "Veteran status: veteran",
            "Veteran statuses: veteran",
            "Military status: active duty",
            "Military statuses: active duty",
            "Immigration status: permanent resident",
            "Immigration statuses: permanent resident",
            "Residency status: resident",
            "Residency statuses: resident",
            "Visa status: work visa",
            "Visa statuses: work visa",
            "Socioeconomic status: low income",
            "Socioeconomic statuses: low income",
            "Country of origin: UK",
            "Countries of origin: UK and Canada",
            "country_of_origin: UK",
            "Place of origin: London",
            "Places of origin: London and Bristol",
            "National origin: British",
            "National origins: British and Canadian",
            "Ancestry: Example ancestry",
            "Ancestries: Example ancestries",
            "Primary language: English",
            "Primary languages: English and French",
            "Native language: Cantonese",
            "native_languages: Cantonese and English",
            "native.languages: Cantonese and English",
            "native-languages: Cantonese and English",
            "Nationality: British",
            "Nationalities: British",
            "Citizenship: UK",
            "Citizenships: UK",
            "Nationality status: British",
            "Nationality statuses: British",
            "Citizenship status: dual citizen",
            "Citizenship statuses: dual citizen",
            "country_of_citizenship: UK",
            "countries_of_citizenship: UK and Canada",
            ...
            "sexual-orientations: bisexual",
            "Religion: Muslim",
            "Religions: Example religions",
            "Philosophical belief: Example belief",
            "Political affiliation: Example Party",
            "Political affiliations: Example Party",
            "Political opinion: Example opinion",
            "Political opinions: Example opinion",
            "Trade union membership: Example Union",
            "Trade union memberships: Example Union",
            "Union membership: Example Union",
            "Union memberships: Example Union",
            "genderIdentity: nonbinary",
            "genderExpression: feminine",
            "ethnicOrigin: Han Chinese",
            "racialOrigin: Example origin",
            "religiousBelief: Example belief",
            "religiousBeliefs: Example beliefs",
            "ethnicBackground: Han Chinese",
            "ethnicBackgrounds: Han Chinese and Cantonese",
            "racialBackground: Example background",
            "racialBackgrounds: Example backgrounds",
            "religiousAffiliation: Example faith",
            "religiousAffiliations: Example faith",
            "ethnicGroup: Example group",
            "ethnicGroups: Example groups",
            "racialIdentity: Example identity",
            "racialIdentities: Example identities",
            ...
            "sexesAssignedAtBirth: female and male",
            "sexAtBirth: female",
            "assignedSex: female",
            "assignedSexes: female and male",
            "assignedSexAtBirth: female",
            "birthSex: female",
            "birthSexes: female and male",
            "genderAssignedAtBirth: female",
            "gendersAssignedAtBirth: female and male",
            "genderAtBirth: female",
            "assignedGender: female",
            "assignedGenders: female and male",
            "assignedGenderAtBirth: female",
            "birthGender: female",
            "birthGenders: female and male",
            "ageRange: 40-49",
            "ageRanges: 40-49",
            "genderIdentities: nonbinary",
            "genderExpressions: feminine",
            "maritalStatus: married",
            "maritalStatuses: married",
            "familyStatus: caregiver",
            "familyStatuses: caregiver",
            "disabilityStatus: disabled",
            "disabilityStatuses: disabled",
            "pregnancyStatus: pregnant",
            "pregnancyStatuses: pregnant",
            "veteranStatus: veteran",
            "veteranStatuses: veteran",
            ...
            "visaStatuses: work visa",
            "socioeconomicStatus: low income",
            "socioeconomicStatuses: low income",
            "countryOfOrigin: UK",
            "countriesOfOrigin: UK and Canada",
            "placeOfOrigin: London",
            "placesOfOrigin: London and Bristol",
            "nationalOrigin: British",
            "nationalOrigins: British and Canadian",
            "ancestries: Example ancestries",
            "primaryLanguage: English",
            "primaryLanguages: English and French",
            "nativeLanguage: Cantonese",
            "nativeLanguages: Cantonese and English",
            "nationalityStatus: British",
            "nationalityStatuses: British",
            "citizenshipStatus: dual citizen",
            "citizenshipStatuses: dual citizen",
            "countryOfCitizenship: UK",
            "countriesOfCitizenship: UK and Canada",
            "sexualOrientation: bisexual",
            "sexualOrientations: bisexual",
            "politicalAffiliation: Example Party",
            "politicalAffiliations: Example Party",
            "politicalOpinion: Example opinion",
            "politicalOpinions: Example opinion",
            "philosophicalBelief: Example belief",
            "tradeUnionMembership: Example Union",
            "tradeUnionMemberships: Example Union",
            "unionMembership: Example Union",
            "unionMemberships: Example Union",
            "**Race:** Black",
            "**Ethnic origin:** Han Chinese",
            "__Religious belief:__ Example belief",
            "**Ethnic background:** Han Chinese",
            "__Religious affiliation:__ Example faith",
            "**Age:** 42",
            "**Sex assigned at birth:** female",
            "**Gender assigned at birth:** female",
            "__Gender expression:__ feminine",
            ...
            "Gender at birth was female",
            "Ethnic origin is Han Chinese",
            "Racial origin was Example origin",
            "Religious belief was Example belief",
            "Ethnic background is Han Chinese",
            "Racial background was Example background",
            "Religious affiliation was Example faith",
            "Gender expression was set to feminine",
        ):
            with self.subTest(source=source):
                self.assertIn(
                    "personal_identifier",
        ...
        for safe_prose in (
            ...
            "Improve sex assigned at birth handling.",
            "Sexes parsing is documented.",
            "Improve gender assigned at birth handling.",
            "Gender at birth parsing is documented.",
            "Assigned gender parsing is documented.",
            "Gender expression parsing is documented.",
            "Genders parsing is documented.",
            "Improve age handling.",
            "Ages parsing is documented.",
            "Race condition handling is documented.",
            "The ethnicity detector needs a regression test.",
            "Ethnic origin parsing is documented.",
            "Racial origin handling is documented.",
            "Religious belief parsing is documented.",
            "Ethnic background parsing is documented.",
            "Ethnic backgrounds parsing is documented.",
            "Racial identity handling is documented.",
            "Religious affiliation parsing is documented.",
            "Faith field handling is documented.",
            "Marital status parsing is documented.",
            "Disability status parsing is documented.",
            "Disabilities parsing is documented.",
            "Disability statuses handling is documented.",
            "Pregnancy statuses handling is documented.",
            "Veteran status handling is documented.",
            "Military statuses handling is documented.",
            "Improve country of origin handling.",
            "National origin parsing is documented.",
            "National origins parsing is documented.",
            "The ancestry detector needs a regression test.",
            "Ancestries parsing is documented.",
            "Primary language parsing is documented.",
            "Primary languages parsing is documented.",
            "The nationality detector needs a regression test.",
            "Nationalities parsing is documented.",
            "Citizenship parsing is documented.",
            "Improve country of citizenship handling.",
            "Improve sexual orientation handling.",
            "The religion detector needs a regression test.",
            "Religions parsing is documented.",
            "Political affiliation parsing is documented.",
            "Political opinions parsing is documented.",
            "Union memberships parsing is documented.",
        ):
            with self.subTest(safe_prose=safe_prose):
                self.assertEqual((), scan_for_leaks(safe_prose))
                self.assertEqual(
